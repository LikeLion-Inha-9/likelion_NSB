...
urlpatterns = [
    ...
    path('idea/<int:i_id>', views.idea_read, name="idea_read"),
    path('idea/comment_create/<int:i_id>', views.idea_comment_create, name="idea_comment_create"),
    path('idea/update/<int:i_id>', views.idea_update, name="idea_update"),
    path('idea/delete/<int:i_id>', views.idea_delete, name="idea_delete"),
    path('idea/comment_update/<int:idea_upload_id>/<int:c_id>', views.idea_comment_update, name="idea_comment_update"),
    path('idea/comment_delete/<int:idea_upload_id>/<int:c_id>', views.idea_comment_delete, name="idea_comment_delete"),
